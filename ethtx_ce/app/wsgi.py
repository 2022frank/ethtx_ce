...
ethtx_config = EthTxConfig(
    ...
    web3nodes={
        ...
        "bscmainnet": dict(hook=os.getenv("BSC_MAIN_URL", ""), poa=True),
        "bsctestnet": dict(hook=os.getenv("BSC_TEST_URL", ""), poa=True),
    },
    ...
    etherscan_urls={
        ...
        "bscmainnet": "https://api.bscscan.com/api?apikey=3N1APPE11V6Q3I9W6D8DGM1PVZZ2PPC65Q",
        "bsctestnet": "https://api-testnet.bscscan.com/api?apikey=3N1APPE11V6Q3I9W6D8DGM1PVZZ2PPC65Q"
    },
)
